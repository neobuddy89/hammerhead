...
export INITRAMFS_SOURCE=`readlink -f $PARENT_DIR/../ramdisks/hammerhead_initramfs_caf_kk`;
...
export CROSS_COMPILE=$PARENT_DIR/../toolchains/arm-hammerhead-linux-gnueabi-4.9.2/bin/arm-hammerhead-linux-gnueabi-;
